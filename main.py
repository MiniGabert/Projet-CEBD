...
class AppWindow(QMainWindow):
    ...
    # TODO 2 DONE : ajouter les fenetres (répertoire gui) et les actions (répertoire actions) correspondant aux 2 items de la partie 2.
    ...
    # TODO 2 DONE : ajouter la définition des méthodes déclenchées lors des clicks sur les boutons de la partie 2
